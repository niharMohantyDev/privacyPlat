...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  ...
  secondary: 'bg-neutral-900 text-white hover:bg-neutral-700 disabled:opacity-50',
  outline: 'border border-neutral-300 text-neutral-700 hover:bg-neutral-50 disabled:opacity-50',
