  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      <main className="mx-auto max-w-2xl p-8">
        <h1 className="text-2xl font-semibold text-neutral-900">Acme Inc.</h1>
        <Card className="mt-6">
          <p className="text-sm text-neutral-600">
            This page stands in for a real customer website. The banner at the bottom is the embeddable
            Consent Banner widget, calling the platform's public Consent API.
          </p>
          <p className="mt-3 text-sm text-neutral-600">
            Reload after deciding — the banner won't reappear, since your decision is fetched and stored.
