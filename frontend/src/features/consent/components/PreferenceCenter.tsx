  ...
  return (
    ...
    >
      <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
        <h2 className="text-lg font-semibold text-neutral-900">Manage Preferences</h2>
          ...
          {purposes.map((purpose) => (
            <li key={purpose.code} className="flex items-start justify-between gap-4">
              ...
              <label className="relative inline-flex shrink-0 cursor-pointer items-center">
                ...
                />
                <div className="h-5 w-9 rounded-full bg-neutral-300 transition peer-checked:bg-indigo-600 peer-disabled:opacity-50" />
